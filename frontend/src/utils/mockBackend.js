...
const DEFAULT_EMPLOYEES = [
  ...
  { id: "usr_emp_3", employeeId: "EMP-103", name: "Omar Al-Fayed", email: "omar@smarttrack.com", role: "employee", title: "DevOps & Infrastructure", department: "Development", avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80", tasksCompleted: 2, tasksAssigned: 8, totalHours: 12, efficiencyRate: 25, status: "Behind", hasAlert: true, alertReason: "Efficiency dropped to 25% (< 40%) & 3 missed deadlines." },
  ...
  { id: "usr_emp_9", employeeId: "EMP-203", name: "Vikram Malhotra", email: "vikram@smarttrack.com", role: "employee", title: "Commercial Account Lead", department: "Sales", avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80", tasksCompleted: 4, tasksAssigned: 10, totalHours: 18, efficiencyRate: 40, status: "Behind", hasAlert: true, alertReason: "Critical sales quota gap & missed 3 deadlines." },
  ...
  { id: "usr_emp_15", employeeId: "EMP-304", name: "Neha Gupta", email: "neha@smarttrack.com", role: "employee", title: "Support Operations Specialist", department: "Support", avatar: "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150&auto=format&fit=crop&q=80", tasksCompleted: 2, tasksAssigned: 7, totalHours: 10, efficiencyRate: 28, status: "Behind", hasAlert: true, alertReason: "Efficiency dropped to 25% (< 40%) & 3 missed deadlines." }
];
  ...
  if (endpoint.includes('/users/analytics')) {
    const activeAlerts = [
      {
        ...
        department: "Development",
        efficiencyRate: 25,
        message: "Attention needed: Omar Al-Fayed",
        reason: "Efficiency dropped to 25% (< 40%) & 3 missed deadlines.",
        avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
        fullUser: DEFAULT_EMPLOYEES[2]
      },
      {
        id: "usr_emp_6",
        employeeId: "EMP-106",
        ...
        department: "Development",
        efficiencyRate: 45,
        message: "Attention needed: Priya Patel",
        reason: "Efficiency dropped to 45% (< 50% threshold).",
        avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80",
        fullUser: DEFAULT_EMPLOYEES[5]
      },
      {
        id: "usr_emp_9",
        employeeId: "EMP-203",
        ...
        department: "Sales",
        efficiencyRate: 40,
        message: "Attention needed: Vikram Malhotra",
        reason: "Critical sales quota gap & missed 3 deadlines.",
        avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80",
        fullUser: DEFAULT_EMPLOYEES[8]
      },
      {
        id: "usr_emp_11",
        employeeId: "EMP-205",
        ...
        department: "Sales",
        efficiencyRate: 33,
        message: "Attention needed: Sameer Khan",
        reason: "Efficiency dropped to 33% (< 40% threshold).",
        avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80",
        fullUser: DEFAULT_EMPLOYEES[10]
      },
      {
        id: "usr_emp_15",
        employeeId: "EMP-304",
        ...
        department: "Support",
        efficiencyRate: 28,
        message: "Attention needed: Neha Gupta",
        reason: "Efficiency dropped to 25% (< 40%) & 3 missed deadlines.",
        avatar: "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=150&auto=format&fit=crop&q=80",
        fullUser: DEFAULT_EMPLOYEES[14]
      }
    ];

    const top10Completed = DEFAULT_EMPLOYEES.slice(0, 10).map(e => ({
    ...
    const analyticsData = {
      ...
      kpis: {
        ...
        avgEfficiency: 69,
        alertCount: 5,
        totalAssignedTasks: 207,
        totalCompletedTasks: 168
      },
      activeAlerts,
      top10Completed,
      ...
      weeklyTrend,
      leaderboards: {
        topPerformers: DEFAULT_EMPLOYEES.filter(e => e.efficiencyRate >= 90).slice(0, 3),
        needsAttention: DEFAULT_EMPLOYEES.filter(e => e.efficiencyRate < 50).slice(0, 3)
      },
